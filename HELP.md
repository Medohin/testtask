...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Spring Web Services, Spring Boot
...
```
$ docker run --rm -p 8080:8080 testtask:0.0.1-SNAPSHOT
```
